    ...
    <div class="row ">
        ...
        <div class="col-md-4 contact-form">
                ...
                <div class="form-group ">
                    <input id="NameId" type="message" class="form-control w-100" placeholder="আপনার নাম">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input id="MessageId" type="text" class="form-control  w-100" placeholder="মেসেজ ">
                </div>
                <button id="sendConfirmBtn" type="submit" class="btn btn-block normal-btn w-100">পাঠিয়ে দিন </button>
        </div>
        <div class="col-md-2">
