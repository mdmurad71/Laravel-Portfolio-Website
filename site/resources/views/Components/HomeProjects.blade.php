    ...
    <div id="one"  class="owl-carousel mb-4 owl-theme">
        ...
        <div class=" m-1 card">
            <div class="text-center">
                ...
                <h5 class="service-card-title mt-4">{{$ProjectsData->projects_name}} </h5>
                <h6 class="service-card-subTitle p-0 m-0">{{$ProjectsData->projects_desc}} </h6>
                <a href="{{$ProjectsData->projects_link}}" target="_blank" class="normal-btn mt-2 mb-4 btn">বিস্তারিত</a>
            </div>
        </div>
